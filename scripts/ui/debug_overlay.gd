...
const _COMBAT_FLOAT_ROWS: Array[Array] = [
	...
	["crash_crush_m", 0.02, 1.0, 0.01],
	["crash_damage_g", 0.0, 400.0, 5.0],
	["crash_damage_per_g", 0.0, 1.0, 0.005],
	...
	["flak_fire_rate", 0.5, 10.0, 0.1],
	["flak_muzzle_speed", 20.0, 150.0, 5.0],
	["flak_shell_gravity_scale", 0.0, 1.0, 0.05],
	["flak_shell_lifetime", 0.3, 5.0, 0.1],
	["flak_arm_distance", 0.0, 20.0, 0.5],
	["flak_fuse_radius", 0.5, 15.0, 0.5],
	["flak_burst_radius", 1.0, 20.0, 0.5],
	["flak_damage", 1.0, 100.0, 1.0],
...
const _ENEMY_FLOAT_ROWS: Array[Array] = [
	...
	["pack_size", 0.0, 24.0, 1.0],
	["swarm_spacing", 0.5, 12.0, 0.25],
	["swarm_separation_gain", 0.0, 5.0, 0.1],
	["swarm_cohesion_gain", 0.0, 5.0, 0.1],
