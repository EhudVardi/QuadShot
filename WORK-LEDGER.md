...
| 8 | The pilot-in-the-loop instrument — the human as the reading | TODO | **Prompt ready: `PROMPT-TASK-8.md`**, refreshed 2026-08-15 to carry the screenshot capability, the mutation-testing and file-editing lessons, and the outstanding flight-list items. Paste the fenced block into a fresh session |
