...
| 8 | The pilot-in-the-loop instrument — the human as the reading | TODO | **Prompt written: `PROMPT-TASK-8.md`** (the human asked for a fresh-session prompt). Paste the block in that file to start it |
